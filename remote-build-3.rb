...
./configure --prefix=$MONO_PREFIX --with-profile4=no --with-profile4_5=yes --with-moonlight=no --disable-boehm --enable-minimal=aot --disable-libraries --with-mcs-docs=no #{TO_LOG}
